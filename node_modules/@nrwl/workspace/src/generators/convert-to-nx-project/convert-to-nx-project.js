...
To upgrade change the version number at the top of ${devkit_1.getWorkspacePath(host)} and run 'nx format'.
`);
        ...
        for (const [project, configuration] of projects) {
            ...
            devkit_1.updateJson(host, devkit_1.getWorkspacePath(host), (value) => {
                value.projects[project] = devkit_1.normalizePath(path_1.dirname(configPath));
                return value;
            });
        }
