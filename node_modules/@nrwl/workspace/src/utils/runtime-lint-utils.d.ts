...
import { ProjectGraph, ProjectGraphDependency, ProjectGraphNode, ProjectGraphProjectNode } from '@nrwl/devkit';
...
export declare function isRelativeImportIntoAnotherProject(imp: string, projectPath: string, projectGraph: MappedProjectGraph, sourceFilePath: string, sourceProject: ProjectGraphNode): boolean;
...
export declare function hasBannedImport(source: ProjectGraphNode, target: ProjectGraphNode, depConstraints: DepConstraint[]): DepConstraint | null;
/**
