...
exports.nxDepsDir = cache_directory_1.cacheDirectory(app_root_1.appRootPath, cache_directory_1.readCacheDirectoryProperty(app_root_1.appRootPath));
exports.nxDepsPath = path_1.join(exports.nxDepsDir, 'nxdeps.json');
function ensureCacheDirectory() {
    try {
        if (!fs_1.existsSync(exports.nxDepsDir)) {
            fs_extra_1.ensureDirSync(exports.nxDepsDir);
        }
    }
    catch (e) {
        /*
         ...
         */
        if (!fileutils_1.directoryExists(exports.nxDepsDir)) {
...
function readCache() {
    ...
    let data = null;
    try {
        if (fileutils_1.fileExists(exports.nxDepsPath)) {
            data = fileutils_1.readJsonFile(exports.nxDepsPath);
        }
    }
    catch (error) {
...
function writeCache(cache) {
    ...
    fileutils_1.writeJsonFile(exports.nxDepsPath, cache);
...
function shouldRecomputeWholeGraph(cache, packageJsonDeps, workspaceJson, nxJson, tsConfig) {
    ...
    if (Object.keys(cache.pathMappings).some((t) => JSON.stringify(cache.pathMappings[t]) !=
