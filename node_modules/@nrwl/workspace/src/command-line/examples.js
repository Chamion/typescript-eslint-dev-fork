...
exports.examples = {
    'print-affected': [
        {
            ...
            description: 'Print information about affected projects and the dependency graph',
        },
        {
    ...
    affected: [
        ...
        },
        {
            ...
            description: 'Rerun the test target only for the projects that failed last time',
        },
        {
    ...
    'affected:build': [
        ...
        },
        {
            ...
            description: 'Rerun the build target only for the projects that failed last time',
        },
        {
    ...
    'affected:lint': [
        ...
        },
        {
            ...
            description: 'Rerun the lint target only for the projects that failed last time',
        },
        {
    ...
    'dep-graph': [
        ...
        },
        {
            ...
            description: 'Generate a static website with dep graph into an html file, accompanied by an asset folder called static',
        },
        {
        ...
        {
            command: 'dep-graph --focus=todos-feature-main --exclude=project-one,project-two',
    ...
    'affected:dep-graph': [
        {
            ...
            description: 'Open the dep graph of the workspace in the browser, and highlight the projects affected by changing the index.ts file',
        },
        {
            command: 'affected:dep-graph --base=main --head=HEAD',
            description: 'Open the dep graph of the workspace in the browser, and highlight the projects affected by the changes between main and HEAD (e.g., PR)',
        },
        {
            command: 'affected:dep-graph --base=main --head=HEAD --file=output.json',
            description: 'Save the dep graph of the workspace in a json file, and highlight the projects affected by the changes between main and HEAD (e.g., PR)',
        },
        {
            command: 'affected:dep-graph --base=main --head=HEAD --file=output.html',
            description: 'Generate a static website with dep graph data in an html file, highlighting the projects affected by the changes between main and HEAD (e.g., PR)',
        },
        {
            command: 'affected:dep-graph --base=main~1 --head=main',
            description: 'Open the dep graph of the workspace in the browser, and highlight the projects affected by the last commit on main',
        },
        {
            command: 'affected:dep-graph --exclude=project-one,project-two',
            description: 'Open the dep graph of the workspace in the browser, highlight the projects affected, but exclude project-one and project-two',
        },
    ],
    'workspace-generator': [],
    list: [
    ...
    'run-many': [
        ...
        {
            command: 'run-many --target=test --projects=proj1,proj2 --parallel --maxParallel=2',
