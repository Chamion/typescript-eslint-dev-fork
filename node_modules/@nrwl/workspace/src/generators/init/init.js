...
function updateTsConfigsJson(host, options) {
    const app = devkit_1.readProjectConfiguration(host, options.name);
...
function getE2eProject(host) {
    ...
    if (key) {
        return devkit_1.readProjectConfiguration(host, key);
    }
    else {
        return null;
    }
...
function moveExistingFiles(host, options) {
    ...
    if (e2eApp) {
        ...
        const newE2eRoot = devkit_1.joinPathFragments('apps', `${getE2eKey(host)}-e2e`);
...
function createAdditionalFiles(host, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const nxJson = {
            ...
            affected: {
                defaultBase: `${options.defaultBase}` || default_base_1.deduceDefaultBase(),
            },
        ...
        host.write('nx.json', fileutils_1.serializeJson(nxJson));
