    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (nxJson.projects) {
            Object.entries(nxJson.projects).forEach(([p, nxJsonConfig]) => {
                var _a, _b;
                const configuration = devkit_1.readProjectConfiguration(host, p);
                ...
                devkit_1.updateProjectConfiguration(host, p, configuration);
            });
            delete nxJson.projects;
        }
        devkit_1.writeJson(host, 'nx.json', nxJson);
        yield devkit_1.formatFiles(host); // format files handles moving config options to new spots.
    });
}
