        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.tryAndRetry(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (terminalOutput) {
                    ...
                    yield fs_extra_1.writeFile(outputPath, terminalOutput);
                }
            }));
        });
    }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            for (let output of outputs) {
                ...
                if ((yield existsAsync(cacheOutputPath)) &&
                    ...
                    return ((yield existsAsync(path_1.join(cachedResult.outputsPath, output))) &&
