...
const daemonHelpOutput = generate_help_output_1.generateDaemonHelpOutput(isGenerateDocsProcess);
...
${daemonHelpOutput}
  `.trimRight()
    ...
    `)
    .command('affected', chalk.bold('Run target for affected projects'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withParallel(withTarget(yargs))), 'affected'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./affected'))).affected('affected', Object.assign({}, args)); }))
    .command('run-many', chalk.bold('Run target for multiple listed projects'), (yargs) => linkToNxDevAndExamples(withRunManyOptions(withParallel(withTarget(yargs))), 'run-many'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./run-many'))).runMany(Object.assign({}, args)); }))
    .command('affected:apps', chalk.bold('Print applications affected by changes'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withPlainOption(yargs)), 'affected:apps'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./affected'))).affected('apps', Object.assign({}, args)); }))
    .command('affected:libs', chalk.bold('Print libraries affected by changes'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withPlainOption(yargs)), 'affected:libs'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    return (yield Promise.resolve().then(() => require('./affected'))).affected('libs', Object.assign({}, args));
}))
    .command('affected:build', chalk.bold('Build applications and publishable libraries affected by changes'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withParallel(yargs)), 'affected:build'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    return (yield Promise.resolve().then(() => require('./affected'))).affected('affected', Object.assign(Object.assign({}, args), { target: 'build' }));
}))
    .command('affected:test', chalk.bold('Test projects affected by changes'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withParallel(yargs)), 'affected:test'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    return (yield Promise.resolve().then(() => require('./affected'))).affected('affected', Object.assign(Object.assign({}, args), { target: 'test' }));
}))
    .command('affected:e2e', chalk.bold('Run e2e tests for the applications affected by changes'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withParallel(yargs)), 'affected:e2e'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    return (yield Promise.resolve().then(() => require('./affected'))).affected('affected', Object.assign(Object.assign({}, args), { target: 'e2e' }));
}))
    .command('affected:dep-graph', chalk.bold('Graph dependencies affected by changes'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withDepGraphOptions(yargs)), 'affected:dep-graph'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    return (yield Promise.resolve().then(() => require('./affected'))).affected('dep-graph', Object.assign({}, args));
}))
    .command('print-affected', chalk.bold('Prints information about the projects and targets affected by changes'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withPrintAffectedOptions(yargs)), 'print-affected'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    return (yield Promise.resolve().then(() => require('./affected'))).affected('print-affected', Object.assign({}, args));
}))
    .command('affected:lint', chalk.bold('Lint projects affected by changes'), (yargs) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    .command('daemon', `${chalk.bold('EXPERIMENTAL: Nx Daemon')}` +
    (daemonHelpOutput
        ? devkit_1.stripIndents `${daemonHelpOutput}`.trimRight()
        : `

The Daemon is not currently running you can start it manually by running the following command:

npx nx daemon
`.trimRight()), (yargs) => linkToNxDevAndExamples(withDaemonStartOptions(yargs), 'daemon'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./daemon'))).daemonHandler(args); }))
    .command('dep-graph', chalk.bold('Graph dependencies within workspace'), (yargs) => linkToNxDevAndExamples(withDepGraphOptions(yargs), 'dep-graph'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./dep-graph'))).generateGraph(args, []); }))
    .command('format:check', chalk.bold('Check for un-formatted files'), (yargs) => linkToNxDevAndExamples(withFormatOptions(yargs), 'format:check'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./format'))).format('check', args); }))
    .command(['format:write', 'format'], chalk.bold('Overwrite un-formatted files'), (yargs) => linkToNxDevAndExamples(withFormatOptions(yargs), 'format:write'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./format'))).format('write', args); }))
    .command('workspace-lint [files..]', chalk.bold('Lint workspace or list of files.  Note: To exclude files from this lint rule, you can add them to the ".nxignore" file'), noop, (_) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./lint'))).workspaceLint(); }))
...
`), (yargs) => linkToNxDevAndExamples(yargs, 'migrate'), () => {
    ...
    .command('connect-to-nx-cloud', chalk.bold(`Makes sure the workspace is connected to Nx Cloud`), (yargs) => linkToNxDevAndExamples(yargs, 'connect-to-nx-cloud'), () => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./connect-to-nx-cloud'))).connectToNxCloudCommand(); }))
    .help('help')
