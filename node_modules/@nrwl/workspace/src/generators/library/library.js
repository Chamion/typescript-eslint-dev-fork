...
function addProject(tree, options) {
    ...
    devkit_1.addProjectConfiguration(tree, options.name, projectConfiguration, options.standaloneConfig);
}
...
function updateTsConfig(tree, options) {
    devkit_1.updateJson(tree, path_1.join(options.projectRoot, 'tsconfig.json'), (json) => {
        if (options.strict) {
