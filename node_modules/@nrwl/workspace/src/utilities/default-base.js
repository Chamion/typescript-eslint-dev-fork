...
function deduceDefaultBase() {
    ...
    try {
        return (child_process_1.execSync('git config --get init.defaultBranch').toString().trim() ||
            nxDefaultBase);
    }
    catch (_a) {
...
function checkGitVersion() {
    try {
        let gitVersionOutput = child_process_1.execSync('git --version').toString().trim();
