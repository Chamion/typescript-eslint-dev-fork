...
*/
const prettierConfig = (_a = prettier_1.resolveConfig.sync(__dirname)) !== null && _a !== void 0 ? _a : {};
...
exports.default = (0, util_1.createRule)({
    ...
    create(context, [{ formatWithPrettier }]) {
        ...
        function prettierFormat(code, location) {
            ...
            try {
                return (0, prettier_1.format)(code, Object.assign(Object.assign({}, prettierConfig), { parser: 'typescript' })).trimRight(); // prettier will insert a new line at the end of the code
            }
            catch (ex) {
                ...
                if (output && output !== literal.value) {
                    context.report({
                        ...
                        fix(fixer) {
                            ...
                            const quote = quoteIn !== null && quoteIn !== void 0 ? quoteIn : getQuote(output);
                            if (quote == null) {
                                return null;
                            }
        ...
        function isNoFormatTemplateTag(tag) {
            return tag.type === experimental_utils_1.AST_NODE_TYPES.Identifier && tag.name === 'noFormat';
        }
        ...
        function checkCallExpression(callExpr, isErrorTest) {
            if (callExpr.callee.type !== experimental_utils_1.AST_NODE_TYPES.MemberExpression) {
                return;
            }
        ...
        function checkInvalidTest(test, isErrorTest = true) {
            for (const prop of test.properties) {
                if (prop.type !== experimental_utils_1.AST_NODE_TYPES.Property ||
                    prop.computed ||
                    prop.key.type !== experimental_utils_1.AST_NODE_TYPES.Identifier) {
                    continue;
                }
