...
function addProjectToNxJsonInTree(projectName, options) {
    return updateWorkspaceInTree((json) => {
        var _a, _b, _c, _d;
        const project = (_a = json.projects[projectName]) !== null && _a !== void 0 ? _a : {};
        project.tags = (_c = (_b = options.tags) !== null && _b !== void 0 ? _b : project.tags) !== null && _c !== void 0 ? _c : [];
        project.implicitDependencies =
            (_d = options.implicitDependencies) !== null && _d !== void 0 ? _d : project.implicitDependencies;
        json.projects[projectName] = project;
        return json;
    });
}
