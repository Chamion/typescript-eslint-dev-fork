...
class TargetProjectLocator {
    constructor(nodes, externalNodes) {
        ...
        this.sortedWorkspaceProjects = this.sortedProjects.map((node) => (Object.assign(Object.assign({}, node), { data: Object.assign(Object.assign({}, node.data), { normalizedRoot: file_utils_1.normalizedProjectRoot(node) }) })));
